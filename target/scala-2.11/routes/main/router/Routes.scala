...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """signUp""", """controllers.HomeController.postSignUP"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """profile""", """controllers.HomeController.profile"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """profile""", """controllers.HomeController.postProfile"""),
  ...
  // @LINE:14
  private[this] lazy val controllers_HomeController_postSignUP4_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("signUp")))
  )
  private[this] lazy val controllers_HomeController_postSignUP4_invoker = createInvoker(
    HomeController_0.postSignUP,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "postSignUP",
  ...
  // @LINE:18
  private[this] lazy val controllers_HomeController_postProfile6_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("profile")))
  )
  private[this] lazy val controllers_HomeController_postProfile6_invoker = createInvoker(
  ...
  // @LINE:21
  private[this] lazy val controllers_HomeController_logout7_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("logout")))
  )
  private[this] lazy val controllers_HomeController_logout7_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:14
    case controllers_HomeController_postSignUP4_route(params) =>
      call { 
        controllers_HomeController_postSignUP4_invoker.call(HomeController_0.postSignUP)
      }
    ...
    // @LINE:18
    case controllers_HomeController_postProfile6_route(params) =>
      call { 
        controllers_HomeController_postProfile6_invoker.call(HomeController_0.postProfile)
      }
  
    // @LINE:21
    case controllers_HomeController_logout7_route(params) =>
      call { 
        controllers_HomeController_logout7_invoker.call(HomeController_0.logout)
      }
